...
#define KOOPA_RETURN_FROM_SHELL_INTERVAL 1000
...
#define ID_ANI_RED_KOOPA_RETURN_FROM_SHELL 60105
#define ID_ANI_RED_KOOPA_DIE 60106
...
#define ID_ANI_GREEN_KOOPA_RETURN_FROM_SHELL 70105
#define ID_ANI_GREEN_KOOPA_DIE 70106
...
protected:
	int type;
	bool isHeld;
	bool isReturnFromShell;
	ULONGLONG return_from_shell_start;
	float leftBoundary;
	float rightBoundary;
	ULONGLONG die_start;
